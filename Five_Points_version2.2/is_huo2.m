function [flag Type] = is_huo2(Step_Set1,Step_Set2)
...
for i = 1:15
    ...
    if flag_temp == 1
        ...
        if   is_existed([sp(1) - 1  sp(2)],Step_Set2) || ...
             is_existed([ep(1) + 1  ep(2)],Step_Set2) || ...
          (  is_existed([ep(1) + 2  ep(2)],Step_Set2) && ( is_existed([sp(1) - 2  sp(2)],Step_Set2) || is_existed([sp(1) - 3  sp(2)],Step_Set2) || is_existed([sp(1) - 4  sp(2)],Step_Set2) )) || ...
          (  is_existed([sp(1) - 2  sp(2)],Step_Set2) && ( is_existed([ep(1) + 2  ep(2)],Step_Set2) || is_existed([ep(1) + 3  ep(2)],Step_Set2) || is_existed([ep(1) + 4  ep(2)],Step_Set2) )) || ...
          (  is_existed([sp(1) - 3  sp(2)],Step_Set2) &&   is_existed([ep(1) + 3  ep(2)],Step_Set2) )
...
for i = 1:15
    ...
    if flag_temp == 1
        ...
        if   is_existed([sp(1)  sp(2) - 1],Step_Set2) || ...
          ...
          (  is_existed([ep(1)  ep(2) + 2],Step_Set2) && ( is_existed([sp(1)  sp(2) - 2],Step_Set2) || is_existed([sp(1)  sp(2) - 3],Step_Set2) || is_existed([sp(1)  sp(2) - 4],Step_Set2) )) || ...
          (  is_existed([sp(1)  sp(2) - 2],Step_Set2) && ( is_existed([ep(1)  ep(2) + 2],Step_Set2) || is_existed([ep(1)  ep(2) + 3],Step_Set2) || is_existed([ep(1)  ep(2) + 4],Step_Set2) )) || ...
          (  is_existed([sp(1)  sp(2) - 3],Step_Set2) &&   is_existed([ep(1)  ep(2) + 3],Step_Set2) )
...
for i = 1:length(x2y)
    ...
    [dim, adjacent_part2] = is_adjacent(Step_Set1(temp,2),2);
    ...
    if flag_temp == 1
        ...
        if   is_existed([sp(1) - 1  sp(2) - 1],Step_Set2) || ...
             is_existed([ep(1) + 1  ep(2) + 1],Step_Set2) || ...
          (  is_existed([ep(1) + 2  ep(2) + 2],Step_Set2) && ( is_existed([sp(1) - 2  sp(2) - 2],Step_Set2) || is_existed([sp(1) - 3  sp(2) - 3],Step_Set2) || is_existed([sp(1) - 4  sp(2) - 4],Step_Set2) )) || ...
          (  is_existed([sp(1) - 2  sp(2) - 2],Step_Set2) && ( is_existed([ep(1) + 2  ep(2) + 2],Step_Set2) || is_existed([ep(1) + 3  ep(2) + 3],Step_Set2) || is_existed([ep(1) + 4  ep(2) + 4],Step_Set2) )) || ...
          (  is_existed([sp(1) - 3  sp(2) - 3],Step_Set2) &&   is_existed([ep(1) + 3  ep(2) + 3],Step_Set2) )
